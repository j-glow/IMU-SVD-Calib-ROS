...
public:
  ImuCalibrationNode()
  : Node("imu_calibration_node"), collecting_(true)
  {
...
private:
  void imu_callback(const sensor_msgs::msg::Imu::SharedPtr msg)
  {
    ...
    if (current_pose_samples_.size() == 100) {
      ...
      bool stable = imu_svd_calib::is_window_stable(current_pose_samples_, avg_acc,
        kMaxWindowDeviation);
  ...
  void run_calibration()
  {
    ...
    bool lm_success = imu_svd_calib::LmCalibration::calibrate(M, ref_mag, guess_A, guess_o, lm_A,
      lm_o);
    ...
    marker_pub_ = this->create_publisher<visualization_msgs::msg::MarkerArray>("/imu_visualization",
      10);
    RCLCPP_INFO(this->get_logger(),
      "Calibration complete. Now publishing RViz markers on /imu_visualization...");
  }
